...
const domainMetadata = [
  {
    ...
    quip: 'links and files that expire. on purpose.',
  },
  {
    name: 'justexplain.cv',
    ...
    quip: 'it explains things properly. i just float.',
  },
  {
    name: 'fxlive.cc',
    url: 'https://fxlive.cc',
    ...
    quip: 'rates that refuse to sit still.',
  },
  {
    name: 'altraic.com',
    ...
    quip: 'still a waitlist. patience is the feature.',
  },
  {
    name: 'vistraic.com',
    ...
    quip: 'minecraft accounts, one pane of glass.',
  },
  {
    name: 'obscurapdf.com',
    description: 'Currently unavailable.',
    offline: true,
    quip: "this one's offline. it happens.",
  },
  {
    name: 'n-ulllabs.com',
